...
var _user$project$Codegen_Function$function = F4(
	function (name, args, type$, body) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A4(_user$project$Codegen_Function$functionType, name, args, type$, body),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'\n',
				A2(
					_elm_lang$core$Basics_ops['++'],
					A4(_user$project$Codegen_Function$functionDeclaration, name, args, type$, body),
					'\n')));
	});
...
var _user$project$Swagger_Decode$Definition = F6(
	function (a, b, c, d, e, f) {
		return {type$: a, required: b, properties: c, items: d, ref$: e, $enum: f};
	});
...
var _user$project$Swagger_Parse$isRequired = F2(
	function (required, name) {
		return A2(_elm_lang$core$List$member, name, required);
	});
var _user$project$Swagger_Parse$toNewItems = F2(
	function (toNewDefinition$, items) {
		var _p2 = items;
		if (_p2.ctor === 'Nothing') {
			return toNewDefinition$(
				{
					ctor: '_Tuple2',
					_0: 'TODO WTF',
					_1: A6(
...
var _user$project$Swagger_Parse$toNewProperties = F2(
	function (toNewDefinition$, properties) {
		var _p3 = properties;
		if (_p3.ctor === 'Nothing') {
			return _elm_lang$core$Native_List.fromArray(
				[]);
...
var _user$project$Swagger_Parse$Bool$ = {ctor: 'Bool\''};
var _user$project$Swagger_Parse$Float$ = {ctor: 'Float\''};
var _user$project$Swagger_Parse$Int$ = {ctor: 'Int\''};
var _user$project$Swagger_Parse$String$ = function (a) {
	return {ctor: 'String\'', _0: a};
};
var _user$project$Swagger_Parse$Ref$ = function (a) {
	return {ctor: 'Ref\'', _0: a};
};
var _user$project$Swagger_Parse$Array$ = function (a) {
	return {ctor: 'Array\'', _0: a};
};
var _user$project$Swagger_Parse$Object$ = function (a) {
...
var _user$project$Swagger_Parse$toNewDefinition = F2(
	function (parentRequired, _p6) {
		...
		var _p10 = _p7._0;
		var isRequired$ = A2(_user$project$Swagger_Parse$isRequired, parentRequired, _p10);
		var _p8 = {ctor: '_Tuple2', _0: _p7._1.type$, _1: _p7._1.ref$};
		_v5_2:
		do {
			if (_p8.ctor === '_Tuple2') {
				if (_p8._1.ctor === 'Just') {
					return A3(
						...
						_p10,
						isRequired$,
						_user$project$Swagger_Parse$Ref$(
						...
						switch (_p9) {
							case 'string':
								return A3(
									...
									_p10,
									isRequired$,
									_user$project$Swagger_Parse$String$(
										A2(_user$project$Swagger_Parse$makeEnum, _p10, _p7._1.$enum)));
							case 'integer':
								return A3(_user$project$Swagger_Parse$Definition, _p10, isRequired$, _user$project$Swagger_Parse$Int$);
							case 'number':
								return A3(_user$project$Swagger_Parse$Definition, _p10, isRequired$, _user$project$Swagger_Parse$Float$);
							case 'boolean':
								return A3(_user$project$Swagger_Parse$Definition, _p10, isRequired$, _user$project$Swagger_Parse$Bool$);
							case 'array':
								return A3(
									_user$project$Swagger_Parse$Definition,
									_p10,
									isRequired$,
									_user$project$Swagger_Parse$Array$(
										A2(
							...
							case 'object':
								return A3(
									...
									_p10,
									isRequired$,
									_user$project$Swagger_Parse$Object$(
										A2(
...
var _user$project$Generate_Type$maybeWrap = F2(
	function (isRequired, body) {
		return isRequired ? body : _user$project$Codegen_Type$maybe(body);
	});
	...
	switch (_p7.ctor) {
		...
		case 'Object\'':
			return _user$project$Codegen_Type$record(
				A2(_elm_lang$core$List$map, _user$project$Generate_Type$renderProperty, _p7._0));
		case 'Array\'':
			return _user$project$Codegen_Type$list(
				_user$project$Generate_Type$renderFieldType(_p7._0._2));
		default:
			return _p7._0;
	}
};
var _user$project$Generate_Type$renderProperty = function (_p9) {
	var _p10 = _p9;
	return A2(
		_user$project$Codegen_Type$recordField,
		_p10._0,
		A2(_user$project$Generate_Type$renderType, _p10._1, _p10._2));
};
var _user$project$Generate_Type$renderRootType = function (_p11) {
	var _p12 = _p11;
	return A2(
	...
	function (constructor, type$) {
		...
		switch (_p0.ctor) {
			case 'String\'':
				var _p1 = _p0._0;
				if (_p1.ctor === 'Enum') {
					return _user$project$Generate_Decoder$decoderName(_p1._0);
				} else {
					return 'string';
				}
			case 'Int\'':
			...
			case 'Bool\'':
				return 'bool';
			case 'Object\'':
				return A2(_user$project$Generate_Decoder$renderObjectDecoder, constructor, _p0._0);
			case 'Array\'':
				return _user$project$Generate_Decoder$renderListDecoder(_p0._0);
			default:
				return _user$project$Generate_Decoder$decoderName(_p0._0);
		}
	});
var _user$project$Generate_Decoder$renderListDecoder = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'(list (',
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_user$project$Generate_Decoder$renderDecoderBody, _p3._0, _p3._2),
			'))'));
};
...
var _user$project$Generate_Decoder$renderObjectDecoderProperty = function (_p4) {
	var _p5 = _p4;
	var _p6 = _p5._0;
	var callee = _p5._1 ? 'required' : 'maybe';
	return A2(
		_elm_lang$core$Basics_ops['++'],
		callee,
		A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'\" ',
					A2(_user$project$Generate_Decoder$renderDecoderBody, _p6, _p5._2)))));
};
var _user$project$Generate_Decoder$renderEnum = function (_p7) {
	var _p8 = _p7;
	var _p9 = _p8._2;
	if ((_p9.ctor === 'String\'') && (_p9._0.ctor === 'Enum')) {
		var _p10 = _p9._0._0;
		return _elm_lang$core$Maybe$Just(
			A4(
				_user$project$Codegen_Function$function,
				_user$project$Generate_Decoder$decoderName(_p10),
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$Basics_ops['++'], 'Decoder ', _p10),
				A2(
						...
						[
							...
							_1: A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$List$map,
										_user$project$Generate_Decoder$renderEnumEach(_p10),
										_p9._0._1),
									_elm_lang$core$Native_List.fromArray(
										[
											_user$project$Generate_Decoder$renderEnumFail(_p10)
										])))
						}
						]),
...
var _user$project$Generate_Decoder$renderDecoder = function (_p11) {
	var _p12 = _p11;
	var _p13 = _p12._0;
	return A4(
		_user$project$Codegen_Function$function,
		...
		A2(_user$project$Generate_Decoder$renderDecoderBody, _p13, _p12._2));
};
	...
	return _elm_lang$core$String$concat(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Generate_Type$renderTypes(definitions$),
				_user$project$Generate_Decoder$renderDecoders(definitions$)
			]));
};
...
var _user$project$Generate$init = function (json) {
	return {ctor: '_Tuple2', _0: json, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$Generate$main = {
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Generate'], 'Generate', typeof _user$project$Generate$main === 'undefined' ? null : _user$project$Generate$main);
