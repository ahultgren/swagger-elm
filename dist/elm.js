...
var _user$project$Codegen_Type$dict = F2(
	function (k, v) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'( Dict ',
...
var _user$project$Swagger_Type$Enum_ = F2(
	function (a, b) {
		return {ctor: 'Enum_', _0: a, _1: b};
	});
...
var _user$project$Swagger_Decode$decodeAlwaysString = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A2(_elm_lang$core$Json_Decode$map, _elm_lang$core$Basics$toString, _elm_lang$core$Json_Decode$string),
		_1: {
			ctor: '::',
...
var _user$project$Swagger_Decode$objectOrDict = function (_p8) {
	var _p9 = _p8;
	var _p10 = {ctor: '_Tuple2', _0: _p9._1, _1: _p9._2};
	_v5_2:
	do {
		if (_p10.ctor === '_Tuple2') {
			if (_p10._0.ctor === 'Nothing') {
				if (_p10._1.ctor === 'Just') {
					return _user$project$Swagger_Type$Dict_(
						_user$project$Swagger_Type$Items(_p10._1._0));
				} else {
					break _v5_2;
				}
			} else {
...
var _user$project$Swagger_Decode$stringOrEnum = F2(
	function ($default, $enum) {
		...
		if (_p11.ctor === 'Nothing') {
			...
			return A2(_user$project$Swagger_Type$Enum_, $default, _p11._0);
		}
	});
var _user$project$Swagger_Decode$decodeString = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Swagger_Decode$apply2(_user$project$Swagger_Decode$stringOrEnum),
	A3(
	...
	var parsed = A2(
		...
		_elm_lang$core$List$head(
			A3(
				...
				ref)));
	var _p13 = parsed;
	if ((_p13.ctor === 'Just') && (_p13._0.ctor === 'Just')) {
		return _p13._0._0;
	} else {
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _user$project$Swagger_Decode$decodeRef = A2(
	...
	function (_p14) {
		return _user$project$Swagger_Type$Ref_(
			_user$project$Swagger_Decode$extractRef(_p14));
	},
	A3(
...
var _user$project$Swagger_Decode$decodeTypeByType = function (_p16) {
	var _p17 = _p16;
	var _p18 = _p17._1;
	if (_p18.ctor === 'Just') {
...
var _user$project$Swagger_Decode$decodeArray = A2(
	...
	function (_p21) {
		return _user$project$Swagger_Type$Array_(
			_user$project$Swagger_Type$Items(_p21));
	},
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'items',
...
var _user$project$Swagger_Decode$decodeTypes = A2(
	...
	A2(
		...
		_elm_lang$core$List$map(
			function (_p25) {
				var _p26 = _p25;
				return A3(_user$project$Swagger_Definition$definition, _elm_lang$core$Maybe$Nothing, _p26._0, _p26._1);
			}),
...
var _user$project$Generate_Type$renderType = function (definition) {
	var type_ = _user$project$Swagger_Definition$getType(definition);
	var name = _user$project$Generate_Utils$typeName(
...
var _user$project$Generate_Decoder$renderEnumFail = function (parentName) {
	return {
		ctor: '_Tuple2',
		_0: '_',
		_1: A2(
...
var _user$project$Generate_Decoder$renderEnumEach = function (value) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Codegen_Literal$string(value),
		_1: A2(
			_elm_lang$core$Basics_ops['++'],
			'Result.Ok ',
			_user$project$Generate_Utils$typeName(value))
	};
};
var _user$project$Generate_Decoder$renderEnumBody = F2(
	function (parentName, $enum) {
		var decoderName_ = _user$project$Generate_Utils$decoderName(parentName);
		return A2(
			_user$project$Codegen_Function$letin,
			{
				...
				_0: {
					...
					_1: A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							A2(_elm_lang$core$List$map, _user$project$Generate_Decoder$renderEnumEach, $enum),
							{
								ctor: '::',
								_0: _user$project$Generate_Decoder$renderEnumFail(parentName),
								_1: {ctor: '[]'}
							}))
				},
				_1: {ctor: '[]'}
...
if (typeof _user$project$Generate$main !== 'undefined') {
    _user$project$Generate$main(Elm['Generate'], 'Generate', undefined);
}
